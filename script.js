...
var play = function() {
    document.getElementById("audio").innerHTML = "<audio controls autoplay loop='loop' class='audio'><source src='Laser Groove.mp3' type='audio/mpeg'>Your browser does not support the audio element.</audio>";
    clicks = clicks + 1;
    if(clicks === 2) {
